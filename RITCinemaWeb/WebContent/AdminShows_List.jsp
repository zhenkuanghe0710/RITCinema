...
<p class="title">
	...
	<a href="./doACSL.do">All</a></b></font>
<form method="post" action="./doACSL.do">
...
<form method="post" action="./doACSL.do">
    ...
    <font face="Arial"><input type="text" size="15" name="show_date"> <input type="submit" value="!"></font>
</form>
<form method="post" action="./doACSL.do">
    <font face="Arial" color="maroon"><b>S</b>how <b>T</b>ime</font>
    <font face="Arial"><input type="text" size="15" name="show_time"> <input type="submit" value="!"></font>
</form>

<font face="Arial" color="#ff8000"><b>S</b>how <b>I</b>nsert</font> 
<form method="post" action="./doIS.do">
    <font face="Arial" color="green"><b>S</b>how <b>I</b>D</font> 
    <input type="text" size="10" name="show_id">
    <font face="Arial" color="maroon"><b>M</b>ovie <b>I</b>D</font> 
    <input type="text" size="10" name="movie_id">
    <font face="Arial" color="maroon"><b>C</b>inema <b>I</b>D</font> 
    <input type="text" size="10" name="cinema_id">
    <font face="Arial" color="maroon"><b>S</b>creen </font> 
    <input type="text" size="10" name="screen"><br>
    <font face="Arial" color="maroon"><b>S</b>eats </font> 
    <input type="text" size="10" name="seats">
    <font face="Arial" color="maroon"><b>S</b>how <b>D</b>ate</font> 
    <input type="text" size="10" name="show_date">
    <font face="Arial" color="maroon"><b>S</b>how <b>T</b>ime</font> 
    <input type="text" size="10" name="show_time">
    <font face="Arial" color="maroon"><b>P</b>rice </font> 
    <input type="text" size="10" name="price"><br>
    <input type="submit"  value="Go,Insert!"></form>
    
<font face="Arial" color="#ff8000"><b>S</b>how <b>U</b>pdate</font>  
<form method="post" action="./doUS.do">
    <font face="Arial" color="green"><b>S</b>how <b>I</b>D</font> 
    <input type="text" size="10" name="show_id">
    <font face="Arial" color="maroon"><b>S</b>creen </font> 
    <input type="text" size="10" name="screen">
    <font face="Arial" color="maroon"><b>S</b>eats </font> 
    <input type="text" size="10" name="seats"><br>
    <font face="Arial" color="maroon"><b>S</b>how <b>D</b>ate</font> 
    <input type="text" size="10" name="show_date">
    <font face="Arial" color="maroon"><b>S</b>how <b>T</b>ime</font> 
    <input type="text" size="10" name="show_time">
    <font face="Arial" color="maroon"><b>P</b>rice </font> 
    <input type="text" size="10" name="price"><br>
    <input type="submit"  value="Go,Update!"></form>
    
<font face="Arial" color="#ff8000"><b>S</b>how <b>D</b>elete</font> 
<form method="post" action="./doDS.do">
    <font face="Arial" color="green"><b>S</b>how <b>I</b>D</font> 
    <input type="text" size="10" name="show_id"><br>
    <input type="submit"  value="Go,Delete!"></form>
